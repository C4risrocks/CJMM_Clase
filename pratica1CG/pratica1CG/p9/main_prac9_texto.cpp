...
void prisma (GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);  //Top
			glNormal3f( 0.0f, 1.0f, 0.0f);
			glTexCoord2f(4, 0.0f); glVertex3fv(vertice[4]);
			glTexCoord2f(4, 4); glVertex3fv(vertice[5]);
			glTexCoord2f(0.0, 4); glVertex3fv(vertice[6]);
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
		glEnd();
}

void prismaPiedra(GLuint textura)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.0, 1); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glEnd();
}
