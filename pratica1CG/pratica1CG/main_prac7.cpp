...
GLfloat mat_diffuse[] = { 0.0, 1.0, 1.0, 1.0 };					// Object Color main
GLfloat mat_specular[] = { 0.0, 0.0, 1.0, 1.0 };				// Specular color
GLfloat mat_shininess[] = { 1.0 };							// 1 to greatest

GLfloat mat_ambient1[] = { 0.0, 0.0, 0.0, 1.0 };					// Color background
GLfloat mat_diffuse1[] = { 0.0, 1.0, 1.0, 1.0 };					// Object Color main
GLfloat mat_specular1[] = { 1.0, 1.0, 1.0, 1.0 };				// Specular color
GLfloat mat_shininess1[] = { 1.0 };							// 1 to greatest
